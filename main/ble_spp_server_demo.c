...
// UART Config taken from example
#define UART_TXD 4
#define UART_RXD 5
...
static void print_write_buffer(void)
{
    ...
    while(temp_spp_recv_data_node_p1 != NULL){
        uart_write_bytes(UART_PORT_NUM, (char *)(temp_spp_recv_data_node_p1->node_buff), temp_spp_recv_data_node_p1->len);
...
#else
                    uart_write_bytes(UART_PORT_NUM, (char *)(p_data->write.value), p_data->write.len);
#endif
                }else{
                    //TODO:
                }
